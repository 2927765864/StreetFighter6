#!/usr/bin/env python3
"""Preview-only stack of E1–E5 onto a dark canvas (not a runtime recipe).

Timeline matches the 17-frame @30fps reference:
  t=0 empty
  t=1..10 E1+E2 (10 frames) + E3/E4/E5
  t=11..14 smoke remnant only
  t=15..16 empty

Layer order: E3, E4, E5 (alpha over) then E2, E1 (additive).
"""
...
def main() -> None:
    ...
    for t in range(N):
        ...
        names = [n for n, s in (("E1", e1), ("E2", e2), ("E3", e3), ("E4", e4), ("E5", e5)) if layer_at(s, t)]
