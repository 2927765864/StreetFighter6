...
const LAYER_FRAME_COUNTS: Record<FlipbookLayerId, number> = {
  ...
  E4b_wide_short_fiber_smoke: 14,
  E4c_wide_short_fiber_smoke: 18,
  E5_narrow_long_smoke: 14,
  E5b_narrow_long_fiber_smoke: 16,
  E5c_narrow_long_fiber_smoke: 28,
  E6_narrow_long_smoke_rtl: 14,
  E6c_wide_short_fiber_smoke: 14,
  E7_sweat_spray: 16,
...
export const FLIPBOOK_SHEETS: Record<FlipbookLayerId, string[]> = {
  ...
  E4b_wide_short_fiber_smoke: urlsFor('E4b_wide_short_fiber_smoke'),
  E4c_wide_short_fiber_smoke: urlsFor('E4c_wide_short_fiber_smoke'),
  E5_narrow_long_smoke: urlsFor('E5_narrow_long_smoke'),
  E5b_narrow_long_fiber_smoke: urlsFor('E5b_narrow_long_fiber_smoke'),
  E5c_narrow_long_fiber_smoke: urlsFor('E5c_narrow_long_fiber_smoke'),
  E6_narrow_long_smoke_rtl: urlsFor('E6_narrow_long_smoke_rtl'),
  E6c_wide_short_fiber_smoke: urlsFor('E6c_wide_short_fiber_smoke'),
